                ...
                <v-form lazy-validation>
                  <v-container>
                    ...
                    <v-row>
                      ...
                      <v-col cols="4">
                        <v-text-field
                          v-model="editedItem.nro_doc_representante_legal"
                          :error-messages="errors.nro_doc_representante_legal"
                          dense
                          label="Doc. Rp. Legal"
                          required
                        ></v-text-field>
...
export default {
  ...
  data: () => ({
    ...
    editedItem: {
      dni: null,
      razon_social: null,
      nro_doc_representante_legal: null,
      nombres: null,
  ...
  methods: {
    ...
    registrar() {
      ...
      axios
        .post("/api/parte/persona-juridica/store", formData, {
          headers: {
